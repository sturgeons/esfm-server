package com.esfm.modules.wizard.controller;
...
import com.esfm.utils.CheckUserAgent;
import com.esfm.utils.YaoSay;
import com.esfm.utils.weixin.SignUtil;
import com.esfm.utils.weixin.TemplateMsgUtil;
import com.esfm.utils.weixin.bo.TemplateBo;
...
//        }
    ...
    public void getTest(HttpServletRequest request) {
        ...
        SysUser sysInfo = sysUserService.getUserInfo(token);

        TemplateBo templateBo = TemplateBo.New();
        String msgStr = templateBo.setTouser(sysInfo.getWxOpenid())
    ...
    public void postTest(HttpServletRequest request) {
        var ss = getJSONParam(request);
        JSONArray array = (JSONArray) ((JSONObject) ss.get("test")).get("array");
        System.out.println(array.get(0));

        System.out.println(((JSONObject) array.get(0)).get("email"));
