...
public class SysRoleController extends ApiController {
    ...
    public ModelAndView exportXls(HttpServletRequest request, HttpServletResponse response) {
        List<SysRole> res = sysRoleService.list();
        var exportXls = new ExportXls<SysRole>("sysRole" + DateTime.now().toString("yyMMddHHmmss"), "demo", "yaoxin");
        return exportXls.export(res, SysRole.class);
    }
    ...
    public R<?> importExcel(HttpServletRequest request, HttpServletResponse response) {
        ImportExcel<SysRole> importExcel = new ImportExcel<>();
        return importExcel.importData(request, SysRole.class, sysRoleService);
    }
    ...
    public R<?> changeMenu(@RequestBody List<SysMenuRole> params) {
        return this.sysRoleService.changeMenu(params);
    }
    ...
    public R<?> getMenu(@RequestParam("id") String id) {
        return this.sysRoleService.getMenu(id);
    }
