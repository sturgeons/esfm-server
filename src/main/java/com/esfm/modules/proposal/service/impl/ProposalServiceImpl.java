...
import com.esfm.modules.proposal.dao.ProposalDao;
...
import com.esfm.modules.proposal.entity.bo.ProposalNextProcessBo;
...
import com.esfm.modules.proposal.service.ProposalService;
...
import com.esfm.utils.WorkFlowParse;
...
public class ProposalServiceImpl extends ServiceImpl<ProposalDao, Proposal> implements ProposalService {
    ...
    public R<?> getProposalListByProcessNo(Page<Proposal> page, String number, String header) {
        SysUser sysUserR = sysLoginInfoService.getUser(header);
        Map<String, String> maps = new HashMap<>();
        maps.put("current_process_no", number);
        maps.put("dept", sysUserR.getDept());
...
SysUser sysUserR = sysLoginInfoService.getUser(header);
        ...
        proposal.setDept(sysUserR.getDept());
    ...
    public R<?> submitProposalMobile(Proposal proposal, String token) {
        ...
        // 设置提案人
        proposal.setStaffId(sysUserR.getId());
        proposal.setStaffName(sysUserR.getName());
        //设置提案时间
        ...
        proposalCallback.setCallbackName(sysUserR.getName());
